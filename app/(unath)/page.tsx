  ...
  return (
    <div className="flex flex-col items-center w-full">
      ...
      <section className="w-full px-0 py-8">
        <h2 className="text-[72px] text-center mb-12 font-bold !font-appleberry max-md:text-[36px]" style={{ color: '#CEA19E' }}>Xưởng Ký Ức có gì?</h2>
        ...
        >
          <div className="flex gap-8 max-lg:flex-col items-center">
            <div className="w-[400px] h-[300px] max-lg:w-full max-lg:h-[200px] rounded-[10px] overflow-hidden flex items-center justify-center">
              <Image src="/(unauth)-homepage/nfc-card-section.png" alt="Thẻ NFC Căn cước Tình yêu" width={400} height={300} className="w-full h-full object-contain" />
            </div>
            <div className="flex-1">
              <h3 className="text-[30px] mb-4 font-bold max-lg:text-[20px]">Thẻ NFC <span style={{ color: '#CEA19E' }}>"Căn cước Tình yêu"</span></h3>
              ...
              <div className="grid grid-cols-2 gap-6 max-lg:grid-cols-1 max-lg:gap-4">
                <div className="flex items-center gap-3">
                  ...
                  <span className="text-sm text-justify flex-1 text-gray-600">Cá nhân hoá thông tin và hình ảnh: biến chiếc thẻ thành căn cước độc quyền của riêng đôi bạn.</span>
                </div>
                <div className="flex items-center gap-3">
                  <div className="w-[40px] h-[40px] relative flex-shrink-0">
                    <div className="absolute inset-0 flex items-center justify-center">
                  ...
                  <span className="text-sm text-justify flex-1 text-gray-600">Mang đi muôn nơi: cảm giác như có người ấy ở bên cạnh.</span>
                </div>
                <div className="flex items-center gap-3">
                  <div className="w-[40px] h-[40px] relative flex-shrink-0">
                    <div className="absolute inset-0 flex items-center justify-center">
                  ...
                  <span className="text-sm text-justify flex-1 text-gray-600">Đánh dấu chủ quyền với người yêu.</span>
                </div>
                <div className="flex items-center gap-3">
                  <div className="w-[40px] h-[40px] relative flex-shrink-0">
                    <div className="absolute inset-0 flex items-center justify-center">
                  ...
                  <span className="text-sm text-justify flex-1 text-gray-600">Quét để truy cập "Nhật ký Tình yêu dễ dàng: trong 1 CHẠM.</span>
                </div>
              </div>
            </div>
          </div>
        ...
        >
          <div className="flex gap-8 max-lg:flex-col items-center">
            <div className="w-[400px] h-[300px] max-lg:w-full max-lg:h-[200px] rounded-[10px] overflow-hidden order-2 max-lg:order-1 flex items-center justify-center">
              <Image src="/(unauth)-homepage/website-section.png" alt="Website Nhật ký Tình yêu" width={400} height={300} className="w-full h-full object-contain" />
            </div>
            <div className="flex-1 order-1 max-lg:order-2">
              <h3 className="text-[30px] mb-4 font-bold max-lg:text-[20px]">Website <span style={{ color: '#CEA19E' }}>"Nhật ký Tình yêu"</span></h3>
              <p className="text-justify text-black mb-6 max-lg:text-sm">
              ...
              <div className="grid grid-cols-2 gap-6 max-lg:grid-cols-1 max-lg:gap-4">
                <div className="flex items-center gap-3">
                  ...
                  <span className="text-sm text-justify flex-1 text-gray-600">Cá nhân hoá từ những chi tiết nhỏ nhất: Tự do tuỳ chỉnh giao diện phù hợp với phong cách yêu.</span>
                </div>
                <div className="flex items-center gap-3">
                  <div className="w-[40px] h-[40px] relative flex-shrink-0">
                    <div className="absolute inset-0 flex items-center justify-center">
                  ...
                  <span className="text-sm text-justify flex-1 text-gray-600">Truy cập dễ dàng: từ domain cá nhân hoá hoặc thẻ NFC "Căn cước Tình yêu".</span>
                </div>
                <div className="flex items-center gap-3">
                  <div className="w-[40px] h-[40px] relative flex-shrink-0">
                    <div className="absolute inset-0 flex items-center justify-center">
                  ...
                  <span className="text-sm text-justify flex-1 text-gray-600">Tải photobooth: từ chính những bức ảnh kỷ niệm trong máy.</span>
                </div>
                <div className="flex items-center gap-3">
                  <div className="w-[40px] h-[40px] relative flex-shrink-0">
                    <div className="absolute inset-0 flex items-center justify-center">
                  ...
                  <span className="text-sm text-justify flex-1 text-gray-600">Đếm ngày yêu & nhận thông báo các cột mốc đáng nhớ.</span>
                </div>
              </div>
            </div>
          </div>
        ...
        >
          <div className="flex gap-8 max-lg:flex-col items-center">
            <div className="w-[400px] h-[300px] max-lg:w-full max-lg:h-[200px] rounded-[10px] overflow-hidden flex items-center justify-center">
              <Image src="/(unauth)-homepage/box-section.png" alt="Hộp Kho báu Tình yêu" width={400} height={300} className="w-full h-full object-contain" />
            </div>
            <div className="flex-1">
              <h3 className="text-[30px] mb-4 font-bold max-lg:text-[20px]">Hộp <span style={{ color: '#CEA19E' }}>"Kho báu Tình yêu"</span></h3>
              <p className="text-justify text-black mb-6 max-lg:text-sm">
                Không chỉ là một chiếc hộp thông thường, mà là nơi để bạn dành những lời ngọt ngào nhất và khoảng khắc bên nhau vui vẻ nhất với người ấy.
              </p>
              <p className="text-justify text-black mb-6 max-lg:text-sm">
                Nhìn hộp thôi đã làm người thương phải rung động, giúp món quà của bạn trở nên ý nghĩa hơn.
              </p>
              <div className="grid grid-cols-2 gap-6 max-lg:grid-cols-1 max-lg:gap-4">
                <div className="flex items-center gap-3">
                  <div className="w-[40px] h-[40px] relative flex-shrink-0">
                  ...
                  <span className="text-sm text-justify flex-1 text-gray-600">Gửi lời ghi chú yêu thương ngay từ packaging bên ngoài.</span>
                </div>
                <div className="flex items-center gap-3">
                  <div className="w-[40px] h-[40px] relative flex-shrink-0">
                    <div className="absolute inset-0 flex items-center justify-center">
                  ...
                  <span className="text-sm text-justify flex-1 text-gray-600">Có thêm những khoảng khắc chơi game vui vẻ cùng người thương.</span>
                </div>
              </div>
            </div>
          </div>
      ...
      <section className="w-full py-8">
        <h2 className="text-[72px] text-center mb-12 font-bold !font-appleberry max-md:text-[36px]" style={{ color: '#CEA19E' }}>Product gallery</h2>
        <div className="grid grid-cols-3 grid-rows-3 gap-0 w-full max-w-[1536px] px-0 max-md:grid-cols-1">
          {[
      ...
      <section className="w-full max-w-[1300px] px-12 py-8 max-md:px-4 max-lg:px-40">
        <h2 className="text-[72px] text-center mb-4 font-bold !font-appleberry max-lg:text-[36px]" style={{ color: '#CEA19E' }}>
          Xưởng Ký Ức có thể giúp gì cho bạn?
        </h2>
        <p className="text-center text-xl mb-12 text-gray-600 max-lg:text-sm max-lg:mb-6">
          Bạn đã biết về Xưởng Ký Ức rồi! Giờ hãy để chúng mình biết nhiều hơn về bạn nhé!
        </p>
            ...
            <div className="flex gap-6 items-center max-lg:flex-row max-lg:gap-3">
              ...
              <div className="flex-1">
                <p className="text-[20px] leading-normal mb-6 text-justify max-lg:text-[14px] max-lg:mb-3">
                  Gửi những thầm kín hay câu chuyện hay ho bạn muốn chia sẻ qua mail của Xưởng Ký Ức!
                </p>
                <div className="flex justify-start">
                  <Link href="mailto:xuongkyuc@gmail.com" target="_blank" rel="noopener noreferrer">
                    <Button variant="secondary" className="!bg-[#2F2F2F] hover:!bg-[#CEA19E] hover:text-black text-white rounded-lg max-lg:text-sm max-lg:py-1 max-lg:px-3 transition-colors duration-300">
                      Chia sẻ ngay
                    </Button>
                  </Link>
                </div>
          ...
          >
            <div className="flex gap-6 items-center max-lg:flex-row max-lg:gap-3">
              ...
              <div className="flex-1">
                ...
                <div className="flex justify-start">
                  <Link href="https://m.me/xuongkyuc" target="_blank" rel="noopener noreferrer">
                    <Button variant="secondary" className="!bg-[#2F2F2F] hover:!bg-[#CEA19E] hover:text-black text-white rounded-lg max-lg:text-sm max-lg:py-1 max-lg:px-3 transition-colors duration-300">
                      Liên hệ ngay
                    </Button>
                  </Link>
